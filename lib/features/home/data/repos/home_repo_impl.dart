...
''');
    ...
    recommendedUsers.sort((a, b) => b.value.compareTo(a.value));

    debugPrint('Recommended users count: ${recommendedUsers.length}');

    return recommendedUsers.map((entry) => entry.key).toList();
  }
